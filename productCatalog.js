...
document.getElementById("inputType").addEventListener('click',function(){
    processSearchType(document.getElementById('inputProductType').value);
});
...
document.getElementById("inputPrice").addEventListener('click',function(){
    processSearchPrice(document.getElementById('inputProductPrice').value);
});
